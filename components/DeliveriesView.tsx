        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative flex-1 md:w-64">
            ...
            <input 
              ...
              className="w-full h-11 pl-9 pr-8 bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-xl text-[10px] font-black uppercase outline-none focus:ring-2 focus:ring-sky-500/20 dark:text-white"
            />
